class Posts:
    ...
    def __init__(self, board_name, no, name, sub, com, filename, ext, time, resto,
                 country, archived, bumplimit, archived_on, country_name,
                 replies, images):
    ...
    def to_tuple(self):
        ...
        return (self.board_name, self.post_no, self.name, self.subject, self.comment, self.filename, self.ext,
                self.post_time, self.resto, self.country, self.country_name, self.replies, self.images, 
